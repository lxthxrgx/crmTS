...
export default function SubleaseTovTerminate() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
        const res = await fetch('http://localhost:5294/api/subleasetovtermination/create', {
            method: 'POST',
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-6 text-center">Форма додаткової угоди про припинення суборенди</h1>
